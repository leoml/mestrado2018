...
JMETER_TEST_PLAN="/jmeter/run_teste/jmeter_1000/vm/AWS_VM_HTTP_Request_mil_mix.jmx" 
JMETER_CSV="/jmeter/run_teste/jmeter_1000/vm/report/HTTP-teste-table-mil.csv"
JMETER_HTML="/jmeter/run_teste/jmeter_1000/vm/html/"

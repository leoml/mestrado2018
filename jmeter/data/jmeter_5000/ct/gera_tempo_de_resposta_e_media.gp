...
#set format y "%.2f"
set title "Tempo de Resposta e Média Tempo de Resposta - Bateria BT-2 CT"
set grid
...
set yrange  [0:200]
plot 'HTTP-teste-table-cinco.csv'  u 1:($2+$14) smooth csplines  ls 1 t 'Tempo de Resposta', \
